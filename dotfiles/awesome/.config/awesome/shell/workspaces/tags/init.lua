-- ~/.config/awesome/shell/workspaces/tags/init.lua
local core = require("shell.workspaces.tags.core")
local layout_policy = require("shell.workspaces.tags.layout_policy")
local focus_policy = require("shell.workspaces.tags.focus_policy")
local client_policy = require("shell.workspaces.tags.client_policy")
