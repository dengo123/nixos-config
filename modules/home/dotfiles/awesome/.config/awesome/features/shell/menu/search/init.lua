...
local Providers = require("features.shell.menu.search.providers")
local View = require("features.shell.menu.search.view")
local Controller = require("features.shell.menu.search.controller")
